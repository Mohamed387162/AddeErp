...
TEMPLATE = DemoTemplate(
    ...
    project_description=(
        ...
        "Área de terreno ~2.100 m2, área construida total (ABC) ~10.800 m2. "
        "Estrutura em concreto armado convencional moldado in loco (NBR 6118), "
        "lajes nervuradas, fundação profunda em estacas helice continua. "
    ...
    boq_name="Orcamento Sintetico - Padrão SINAPI",
    boq_description=(
        "Orcamento sintetico por etapas conforme pratica brasileira, "
        "composições referenciadas ao SINAPI (CAIXA/IBGE) Sao Paulo, "
    ...
    sections=[
        ...
        (
            ...
            [
                ...
                ("01.004", "Ligação provisoria de água e esgoto (Temporary water/sewer)", "lsum", 1, 12000.00, {"sinapi": "98459"}),
                ("01.005", "Ligação provisoria de energia elétrica trifasica (Temporary power)", "lsum", 1, 18500.00, {"sinapi": "98460"}),
                ("01.006", "Locação da obra com gabarito de tabuas (Setting out)", "m2", 1900, 14.50, {"sinapi": "74077/001"}),
        ...
        (
            ...
            [
                ...
                ("03.009", "Impermeabilização de baldrame com manta asfaltica (Waterproofing)", "m2", 1200, 58.00, {"nbr": "NBR 9575"}),
        ...
        (
            ...
            [
                ...
                ("04.004", "Forma de pilar em chapa metálica reaproveitavel (Column steel forms)", "m2", 4200, 118.00, {"sinapi": "92444"}),
        ...
        (
            ...
            {"sinapi": "ALVENARIA"},
            [
                ("05.001", "Alvenaria de bloco ceramico vedação 14x19x39cm (Ceramic block wall)", "m2", 18500, 78.00, {"sinapi": "87489"}),
        ...
        (
            ...
            {"nbr": "NBR 9575"},
            [
                ("06.001", "Impermeabilização de laje de cobertura com manta asfaltica 4mm (Roof waterproofing)", "m2", 1850, 88.00, {"nbr": "NBR 9575"}),
                ("06.002", "Impermeabilização de áreas frias / banheiros com membrana (Wet área waterproofing)", "m2", 4200, 62.00, {"nbr": "NBR 9575"}),
                ("06.003", "Proteção mecanica de impermeabilização em argamassa (Screed protection)", "m2", 1850, 32.00, {"sinapi": "98557"}),
                ("06.004", "Telhado metálico termoacustico sobre casa de maquinas (Metal roof)", "m2", 420, 165.00, {"nbr": "NBR 8800"}),
        ...
        (
            ...
            [
                ...
                ("07.004", "Revestimento ceramico de parede 30x60cm áreas molhadas (Wall tiling)", "m2", 8400, 88.00, {"sinapi": "87263"}),
        ...
        (
            ...
            [
                ...
                ("08.007", "Corrimao metálico em escadas - NBR 9050 (Handrails)", "m", 680, 165.00, {"nbr": "NBR 9050"}),
        ...
        (
            ...
            {"nbr": "NBR 5626"},
            [
                ("09.001", "Tubulação de água fria PVC soldavel (Cold water piping)", "m", 6200, 28.00, {"nbr": "NBR 5626"}),
                ("09.002", "Tubulação de água quente CPVC (Hot water piping)", "m", 2800, 42.00, {"nbr": "NBR 7198"}),
                ("09.003", "Tubulação de esgoto e ventilação PVC serie normal (Drainage/vent)", "m", 5400, 38.00, {"nbr": "NBR 8160"}),
                ("09.004", "Tubulação de águas pluviais PVC (Rainwater piping)", "m", 1800, 42.00, {"nbr": "NBR 10844"}),
                ("09.005", "Louca sanitária - bacia com caixa acoplada (WC suite)", "pcs", 200, 580.00, {"sinapi": "86888"}),
        ...
        (
            ...
            {"nbr": "NBR 5410"},
            [
                ("10.001", "Quadro de distribuição geral de baixa tensao QGBT (Main LV board)", "pcs", 1, 48000.00, {"nbr": "NBR 5410"}),
                ...
                ("10.012", "Ponto de recarga de veiculo elétrico garagem (EV charging point)", "pcs", 24, 6800.00, {"nbr": "NBR 17019"}),
        ...
        (
            ...
            [
                ...
                ("12.002", "Pintura latex acrílica interna 2 demaos (Internal acrylic paint)", "m2", 26000, 18.50, {"sinapi": "88489"}),
                ...
                ("12.005", "Pintura epoxi em piso de garagem e demarcação (Epoxy garage paint)", "m2", 5200, 32.00, {"sinapi": "EPOXI"}),
        ...
        (
            "13",
            "Servicos Complementares e Áreas Comuns (Complementary / amenities)",
            {"sinapi": "COMPLEMENTAR"},
            [
                ...
                ("13.003", "Academia, salao de festas e mobiliário fixo (Gym/party room fit-out)", "lsum", 1, 320000.00, {"sinapi": "FITOUT"}),
    ...
    project_metadata={
        ...
        "standards": [
            ...
            "NBR 5410 (instalações elétricas de baixa tensao)",
        ...
        "tax_note": (
            ...
            "valor dos servicos, conforme legislação do municipio. PIS/COFINS e "
        ...
        "permit_note": (
            "Alvara de aprovação e execução pela Prefeitura de Sao Paulo; "
    ...
    tender_packages=[
        ...
        (
            ...
            "Instalações hidrossanitárias, elétricas, SPDA, telecom e incendio",
            "evaluating",
            [
